...
<div class="container">
<center><h4><b>YOUR ORDER HAS BEEN PLACED SUCCESSFULLY</b></h4></center><br>
<div align="right"><a href="<c:url value= '/continue'/>" ><button type="submit" class="btn btn-warning">CONTINUE SHOPPING</button></a></div>
 <div align="center"><h4><b>${ordersum}</b></h4></div><br>
 <table class="table">
<thead> 
 <tr>
...
<tr>
<td><img src="<c:url value='resources/images/${orderr.product.id}.jpg'/>" width=60px
								height=60px></td>
...
<div class="row">
 <div class="col-sm-3">
 <h4><b>ADDRESSDETAILS</b></h4>
  <b>NAME:</b>${details.user.username}<br>
<b>DOOR NO:</b>${details.doornumber}<br>
<b>STREETNAME:</b>${details.streetname}<br>
<b>LOCALITY:</b>${details.locality}<br>

<b>CITY:</b>${details.city}<br>
<b>PINCODE:</b>${details.pincode}<br>
<b>MOBILE NUMBER:</b>${details.mobilenumber}<br>
<b>STATE:</b>${details.state}<br>
<b>COUNTRY:</b>${details.country}<br>
<%--<b>${details.user.username}</b><br>
 ${details.mobilenumber}<br><br>
${details.doornumber},${details.streetname}<br>
${details.locality}<br>
...
<div class="col-sm-3">
<div class="item">
             <img src="resources/pictures/delivery.gif"  width=300; height=200; class="img-responsive">
            </div>
</div></div>
